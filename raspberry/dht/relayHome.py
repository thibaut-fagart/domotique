...
oidArduinoSalonTemp = "1.3.6.1.4.1.36582.1"
oidArduinoSalonHum  = "1.3.6.1.4.1.36582.2"
...
oidDht22PcTemp      = "1.3.6.1.4.1.43689.1.2.5.1.0"
oidDht22PcHum       = "1.3.6.1.4.1.43689.1.2.5.2.0"
...
if __name__ == "__main__":
  ...
  oidSalonTemp, tempSalon = getSnmp(ipHostHome,oidArduinoSalonTemp)
  resultSetT = setSnmp(ipHostSnmp,oidDht22SalonTemp,int(tempSalon))

  oidSalonHum, humSalon = getSnmp(ipHostHome,oidArduinoSalonHum)
  resultSetH = setSnmp(ipHostSnmp,oidDht22SalonHum,int(humSalon))
