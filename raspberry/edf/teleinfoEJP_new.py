...
from edf.teleinfo import oidEdfIsousc, oidEdfIinst
...
class Edf:
    ...
    def __init__(self):
        self.etiquettes = {}
        self.etiquettes['ISOUSC'] = Etiquette(Edf.oidEdfIsousc,'ISOUSC' )
        self.etiquettes['IINST1'] = Etiquette(Edf.oidEdfIinst1, 'IINST1')
        self.etiquettes['IINST2'] = Etiquette(Edf.oidEdfIinst2, 'IINST2')
        self.etiquettes['IINST3'] = Etiquette(Edf.oidEdfIinst3, 'IINST3')
        self.etiquettes['PAPP'] = Etiquette(Edf.oidEdfPapp, 'PAPP')
        self.etiquettes['EJPHN'] = Etiquette(Edf.oidEdfIsousc, 'EJPHN')
        self.etiquettes['EJPHPM'] = Etiquette(Edf.oidEdfIsousc, 'EJPHPM')
...
def teleinfoEJP():
    ...
    for etiquette in tramesOk:
        ...
        if edf.etiquettes[etiquette]:
            print "reading %s " % etiquette
